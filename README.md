...
- Hampir sama ya dengan script bot views kemarin, cuman yaa script ini saya edit sedikit. Untuk bot nya saya mengambil dari website **https://zefoy.com/** (Buka Di Chrome)
...
$ python l.py
```
Jika anda ingin menggunakan tools buff like (hati)
```
$ python s.py
```
Jika anda ingin menggunakan tools buff share
- CD Untuk Buff Like 15 Menit Untuk Setiap 25 Like
- CD Untuk Buff Share 2 - 3 Menit Untuk 200+ Share
